          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 flex flex-col overflow-hidden group">
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <Link to="/track/python-algo" className="block w-full py-3 border-2 border-[#1E1B4B] text-[#1E1B4B] rounded-lg font-bold hover:bg-[#1E1B4B] hover:text-white transition text-center">
                  Подробнее
                </Link>
              </div>
            </div>
